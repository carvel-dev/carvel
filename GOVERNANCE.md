# Welcome to the Carvel Governance Guide

Welcome to the Carvel Governance Guide. This document outlines how our open-source community collaborates, makes decisions, and maintains project integrity.
...
Ideally, all project decisions are resolved by consensus."Maintainers can either vote 'agree, yes, +1', 'disagree, no, -1', or 'abstain'."
...
The proposal process, including a
See the [Proposal Template](https://github.com/carvel-dev/carvel/tree/develop/proposals#proposal-template)  
Refer to the [Proposal Directory](https://github.com/carvel-dev/carvel/tree/develop/proposals)
