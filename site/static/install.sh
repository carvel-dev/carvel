...
install() {
  ...
  if [[ `uname` == Darwin ]]; then
    ...
    vendir_checksum=39a703e8fed93334e075ba6d25456a2320e2dea9c1d144afebc7c081e707733b
    ...
    vendir_checksum=f4f0c815e5bf1f5b3265e020fd6ed29f613f0d2171cfe9c03f92ded9ff83f206
  ...
  $dl_bin github.com/vmware-tanzu/carvel-vendir/releases/download/v0.28.0/vendir-${binary_type} > /tmp/vendir
  echo "${vendir_checksum}  /tmp/vendir" | shasum -c -
  mv /tmp/vendir ${dst_dir}/vendir
  chmod +x ${dst_dir}/vendir
  echo "Installed ${dst_dir}/vendir v0.28.0"
