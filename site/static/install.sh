...
install() {
  ...
  if [[ `uname` == Darwin ]]; then
    ...
    imgpkg_checksum=bf839a539c90a22287904e2a83c4322bf00da3150d8d47cb9fb5eb59dfe41111
    ...
    vendir_checksum=5ee954207d6324f336341b2a81c0cb6147f08e7f892fbc52c28effc81bc2302f
    ...
    imgpkg_checksum=e8a9a3d37a125eca49b8c074ee2f5c84616e765f20ee6c6d60f79dae8f19af10
    ...
    vendir_checksum=eb66c8fd398925e2a2e68a2f65de3ca06207addd86cf207c07f7ad566dbe7b25
  ...
  $dl_bin github.com/vmware-tanzu/carvel-imgpkg/releases/download/v0.31.0/imgpkg-${binary_type} > /tmp/imgpkg
  echo "${imgpkg_checksum}  /tmp/imgpkg" | shasum -c -
  mv /tmp/imgpkg ${dst_dir}/imgpkg
  chmod +x ${dst_dir}/imgpkg
  echo "Installed ${dst_dir}/imgpkg v0.31.0"
  ...
  $dl_bin github.com/vmware-tanzu/carvel-vendir/releases/download/v0.30.0/vendir-${binary_type} > /tmp/vendir
  echo "${vendir_checksum}  /tmp/vendir" | shasum -c -
  mv /tmp/vendir ${dst_dir}/vendir
  chmod +x ${dst_dir}/vendir
  echo "Installed ${dst_dir}/vendir v0.30.0"
