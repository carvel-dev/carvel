...
install() {
  ...
  if [[ x`uname` == xDarwin ]]; then
    ...
    kapp_checksum=39efaf9be55571852db01ab59f436a28b1e2e74052be61a98e8205e0b85791ac
    ...
    kapp_checksum=031020e3cd83883900695959f067d8afc64369c09d127a0ed34eeee3e264e422
