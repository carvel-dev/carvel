...
install() {
	...
	echo "Installing ytt..."
	wget -O- https://github.com/k14s/ytt/releases/download/v0.15.0/ytt-linux-amd64 > /tmp/ytt
	echo "180e209f6c5a28726b3fe628aee3a6c2ec680b712591777af46b1721a98f04b1  /tmp/ytt" | shasum -c -
