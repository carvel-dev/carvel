...
install() {
  ...
  if [[ x`uname` == xDarwin ]]; then
    ...
    kapp_checksum=e46aa8b334832275ddf9b982c0b88633bc891a8ffff1e0204ee36cf2fb2f20fb
    ...
    kapp_checksum=4f08b5e3639c2d126903efa81cbc1af2ff342464cc24815442c190e4b220d52f
