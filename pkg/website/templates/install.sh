...
install() {
	...
	wget -O- https://github.com/k14s/kbld/releases/download/v0.10.0/kbld-linux-amd64 > /tmp/kbld
	echo "56a0ba05431d3e5e4da0da710ba0b7ce98a7f848c15509359da2e58d451cae72  /tmp/kbld" | shasum -c -
