...
install() {
	...
	wget -O- https://github.com/k14s/kapp/releases/download/v0.8.0/kapp-linux-amd64 > /tmp/kapp
	echo "010060339f5be1a1bfca97fa0c69179b8471908affa04bf32a5bab241a2f8d78  /tmp/kapp" | shasum -c -
