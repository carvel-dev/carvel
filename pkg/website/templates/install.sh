...
install() {
  ...
  if [[ x`uname` == xDarwin ]]; then
    ...
    kbld_checksum=e9442199a127877681bf70200d69d0e2d15cf061801e5b9998473ee5c144a712
    ...
    kbld_checksum=396f02f1d9f320cf5089c19aa9c5d014949cfba8d6029a562fe73212bc483db4
