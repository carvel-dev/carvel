...
install() {
  ...
  if [[ x`uname` == xDarwin ]]; then
    ...
    kbld_checksum=1da8bd208e49a1faeb48b167ba5fc69b10b94b74c0e6289bd0adbe043f524b4f
    ...
    kbld_checksum=9946ae1c154be0dfa301e316cf4403d6961096a79458656df5eba634f4c9250c
