...
install() {
  ...
  if [[ x`uname` == xDarwin ]]; then
    ...
    kbld_checksum=65ac1a4b108c1478bf53883bfec492577d80cf950f90a6e9331b202dbff4bad5
    ...
    kbld_checksum=63d35026696ffa23ea4dbf52d47cda02e1844a538fead30bf2ea78ea92410c21
