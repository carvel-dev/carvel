...
install() {
	...
	wget -O- https://github.com/k14s/kapp/releases/download/v0.15.0/kapp-linux-amd64 > /tmp/kapp
	echo "70bee927591f848f79bdf0888034cb55ed4f6b0e8389aea1f23264effc59160b  /tmp/kapp" | shasum -c -
