...
install() {
  ...
  if [[ x`uname` == xDarwin ]]; then
    ...
    vendir_checksum=d5216373ea0f319402f516483c2d86fa4cb42fd1abd3bea08fed21773e98f5f2
  else
    ...
    vendir_checksum=5d45cac346fad415150b82c3bf60110525a907d8545ac4c1d972d4f85985b16e
  fi
