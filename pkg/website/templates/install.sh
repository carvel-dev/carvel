...
install() {
  ...
  if [[ x`uname` == xDarwin ]]; then
    ...
    kbld_checksum=09b348bfb92c25bb47444fe6ace9659b1bf062334a31d8092de98014c431378b
    ...
    kbld_checksum=ed16c560011eda40f07bad032859879904c3a264c478986151cae10815ced884
