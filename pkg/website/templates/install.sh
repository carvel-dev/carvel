...
install() {
  ...
  if [[ x`uname` == xDarwin ]]; then
    ...
    kbld_checksum=39751dc1b2cae5c9f64f342732083ae503bd5e8d44a6b3ffeaeb3ac3b97fdb4c
    ...
    kbld_checksum=d949a139b0fe803ff2fafa4ff96bc49917eeda88f79516ebf34617b872ce19ec
