...
install() {
  ...
  if [[ x`uname` == xDarwin ]]; then
    ...
    vendir_checksum=de6da267406b90ac29ea87c831d18811681cc339115bc7b0e5f155227914f024
  else
    ...
    vendir_checksum=85bce9171f2f18da51695db185b33df2d4d555495cc45429e4838edf73b89d77
  fi
