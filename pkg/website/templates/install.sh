...
install() {
  ...
  if [[ x`uname` == xDarwin ]]; then
    ...
    kapp_checksum=de558603a95fdc42b73d337ecef0b6bf41c2c098dba9b71524feda734b857cf7
    ...
    kapp_checksum=9b760e6dfb8e8ed4886141affb99d6b4ab7e80178f3991cbb68f44a5bc1353de
