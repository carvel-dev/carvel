...
Consider using [ytt](https://carvel.dev/ytt) and [its overlay feature](https://github.com/vmware-tanzu/carvel-ytt/blob/develop/docs/lang-ref-ytt-overlay.md) to change values if you do not control source configuration.
